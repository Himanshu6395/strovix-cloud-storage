...
public class EmailService {
    ...
    /** @return true if Brevo accepted the request */
    public boolean sendTransactionalEmail(String toEmail, String toName, String subject, String htmlContent, String textContent, List<String> tags) {
        if (brevoApiKey == null || brevoApiKey.isEmpty()) {
            log.warn("Cannot send email to {}. Brevo is not configured (BREVO_API_KEY).", toEmail);
            return false;
        }
    ...
    public boolean sendFileShareEmail(String recipientEmail, String recipientName, String senderName, String resourceName, String permission, String resourceId) {
        ...
        String link = frontendBase() + "/shared";
        String html = "<p>" + senderName + " shared the file <b>" + resourceName + "</b> with you (" + permission + ").</p><p><a href='" + link + "'>View File</a></p>";
        String text = senderName + " shared the file " + resourceName + " with you. Open: " + link;
    ...
    public boolean sendFolderShareEmail(String recipientEmail, String recipientName, String senderName, String resourceName, String permission, String resourceId) {
        ...
        String link = frontendBase() + "/shared";
        String html = "<p>" + senderName + " shared the folder <b>" + resourceName + "</b> with you (" + permission + ").</p><p><a href='" + link + "'>View Folder</a></p>";
        String text = senderName + " shared the folder " + resourceName + " with you. Open: " + link;
    ...
    public boolean sendShareInviteEmail(String recipientEmail, String senderName, String resourceName, String resourceType, String permission, String inviteToken) {
        ...
        String inviteUrl = frontendBase() + "/register?email=" + recipientEmail + "&invite=" + inviteToken;
        ...
        String text = senderName + " invited you to collaborate on " + resourceName + ". Open: " + inviteUrl;
    ...
    public boolean sendPublicLinkEmail(String recipientEmail, String recipientName, String senderName, String resourceName, String resourceType, String token) {
        ...
        String shareUrl = frontendBase() + "/share/" + token;
        ...
        String text = senderName + " shared a public link for " + resourceName + ". Open: " + shareUrl;
        return sendTransactionalEmail(recipientEmail, recipientName, subject, html, text, Collections.singletonList("PUBLIC_LINK"));
    }

    public String publicShareUrl(String token) {
        return frontendBase() + "/share/" + token;
    }
}
